        ...
        >
          ...
          <div className="relative flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-4 rounded-3xl border border-dashed border-[#1c5a6b33] bg-[#f2fbff] p-6 md:flex-row md:items-center md:justify-between">
              ...
              <Link
                href="#intake"
                className="inline-flex items-center justify-center rounded-full bg-[#b87745] px-6 py-3 text-sm font-semibold text-white shadow-[0_18px_35px_rgba(184,119,69,0.22)] transition hover:-translate-y-0.5 hover:bg-[#a8693d]"
              >
